...
class BFV:
    ...
    def EvalKeyGenV2(self, p):
        ...
        c0 = ref_poly_mul2(a.F,self.sk.F)
        c0 = [c0_+e_ for c0_,e_ in zip(c0,e.F)]
        c1 = ref_poly_mul2(self.sk.F,self.sk.F)
    ...
    def RelinearizationV2(self,ct):
        ...
        c2_0 = ref_poly_mul2(c2.F,self.rlk2[0].F)
        c2_0 = [round(c/self.p) for c in c2_0]
        c2_0 = [(c % self.q) for c in c2_0]

        c2_1 = ref_poly_mul2(c2.F,self.rlk2[1].F)
    ...
    def HomomorphicMultiplication(self, ct0, ct1):
        ...
        r0 = ref_poly_mul2(ct00.F,ct10.F)
        r1 = ref_poly_mul2(ct00.F,ct11.F)
        r2 = ref_poly_mul2(ct01.F,ct10.F)
        r3 = ref_poly_mul2(ct01.F,ct11.F)
