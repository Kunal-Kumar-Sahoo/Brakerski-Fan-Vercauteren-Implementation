...
class Poly:
    ...
    def __add__(self, b):
        if self.inNTT != b.inNTT:
            raise Exception('Polynomial Addition: Inputs must be in the same domain.')
        elif self.q != b.q:
            raise Exception('Polynomial Addition: Inputs must have the same modulus.')
        else:
